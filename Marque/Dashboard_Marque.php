...
$arrayPendingRequest = $a->displayPendingRequestMarques($_SESSION["User_ID"]);
$arrayDailyEarnings = $a->displayDailyEarningsMarques($_SESSION["User_ID"]);
$arrayMonthlyEarnings = $a->displayMonthlyEarningsMarques($_SESSION["User_ID"]);
$arrayNumberProducts = $a->displayNumberProductsMarques($_SESSION["User_ID"]);
$arrayPdvPieChart = $a->displayProductPieChartMarques($_SESSION["User_ID"]);
...
<body id="page-top">
    ...
    <div id="wrapper">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Earnings (Today)</div>
                                            <?php if (is_null($arrayDailyEarnings[0]->Earnings)) { ?>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">0 DA</div>
                                            <?php } else { ?>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $arrayDailyEarnings[0]->Earnings ?> DA</div>
                                            <?php } ?>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <?php if (is_null($arrayMonthlyEarnings[0]->Earnings)) { ?>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">0 DA</div>
                                            <?php } else { ?>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $arrayMonthlyEarnings[0]->Earnings ?> DA</div>
                                            <?php } ?>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <?php if (is_null($arrayNumberProducts->Products)) { ?>
                                                    <div class="col-auto">
                                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">No Products</div>
                                                    </div>
                                                <?php } else { ?>
                                                    <div class="col-auto">
                                                        <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $arrayNumberProducts->Products ?></div>
                                                    </div>
                                                <?php } ?>
                                            </div>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $arrayPendingRequest->commandes ?></div>
                                        </div>
                                        <div class="col-auto">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-5">
                            <div class="card shadow mb-4">
                                ...
                                <!-- circle -->
                                <div class="card-body">
                                    <?php if (count($arrayPdvPieChart) != 0) { ?>
                                        <div class="chart-pie pt-4 pb-2">
                                            <canvas id="myPieChart"></canvas>
                                        </div>
                                    <?php } else { ?>
                                        <div class="text-center">
                                            <img src="img/pas de donnees.jpg">
                                        </div>
                                    <?php } ?>
                                    <div class="mt-4 text-center small">
                                        <?php if (count($arrayPdvPieChart) == 3) { ?>
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-primary"></i> <?= $arrayPdvPieChart[0]->name ?>
                                            </span>
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-success"></i> <?= $arrayPdvPieChart[1]->name ?>
                                            </span>
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-info"></i> <?= $arrayPdvPieChart[2]->name ?>
                                            </span>
                                        <?php } else if (count($arrayPdvPieChart) == 2) { ?>
                                            <span class="mr-2">
                                                <i class="fas fa-circle text-primary"></i> <?= $arrayPdvPieChart[0]->name ?>
                                            </span>
                                            <span class="mr-2">
                                        ...
                                        <?php } else if (count($arrayPdvPieChart) == 1) { ?>
                                            <i class="fas fa-circle text-primary"></i> <?= $arrayPdvPieChart[0]->name ?>
                                        <?php } ?>
        ...
        <script>
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8000/api/overviewEarningsMarques",
                data: {
                    user_id: <?php echo $_SESSION["User_ID"] ?>
                },
                success: function(rsp) {
                    var months = rsp.map(function(data) {
                        return data.Month
                    });

                    var Earnings = rsp.map(function(data) {
        ...
        <script>
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8000/api/displayProductPieChartMarques",
                data: {
                    user_id: <?php echo $_SESSION["User_ID"] ?>
                },
                success: function(rsp) {
                    var pdvName = rsp.map(function(pdv) {
                        return pdv.name
                    });

                    var pdvTP = rsp.map(function(pdv) {
                        return pdv.totalPrice
                    });
