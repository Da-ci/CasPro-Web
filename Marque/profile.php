                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-secondary">
                                        <?php echo (strtoupper($array->name)); ?>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <h6 class="mb-0">Registe de commerce</h6>
                                    </div>
                                    <div class="col-6 text-secondary">
                                        <?php echo ($array->RC); ?>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <h6 class="mb-0">Numéro d'identification fiscale</h6>
                                    </div>
                                    <div class="col-6 text-secondary">
                                        <?php echo ($array->NIF); ?>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <h6 class=" mb-0">Numéro d'identification statistique </h6>
                                    </div>
                                    <div class="col-6 text-secondary">
                                        <?php echo ($array->NIS); ?>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <h6 class="mb-0">Article d'imposition </h6>
                                    </div>
                                    <div class="col-6 text-secondary">
                                        <?php echo ($array->AI); ?>
                                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 text-secondary">
                                        <?php echo (substr($array->created_at, 0, 9)); ?>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <a class="btn " style="background-color:#6d358b ; border-color:#6d358b ; color:white" href="profile_edit.php">Modifie</a>
                                    </div>
                                </div>
                            </div>
                        </div>
