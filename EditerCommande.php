...
<body id="page-top">
                            ...
                            <div class="row">
                                <div class="col-sm-12"><br>
                                    <div class="panel panel-default invoice" id="invoice">
                                        <div class="panel-body">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                ...
                                                <div class="col-xs-4 to">
                                                    <p class="lead marginbottom">Point de vente : <?php echo $arrayCommande->Pdv->name ?> </p>
                                            ...
                                            <div class="d-flex">
                                                <div class="">
                                                    <p>Marque</p>
                                                    <select class="form-control" id="getMark">
                                        ...
                                        <div id="addDiv" class="d-flex flex-row">
                                                ...
                                                <tbody>
                                                    <?php foreach ($arrayCommande->Products as $Product) { ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo ($Product->quantity * $Product->pivot->quantity) ?></td>
                                                            <td> <button type="button" class="deleteBtn btn btn-danger"><i class="fa-solid fa-x"></i></button> </td>
                                                        </tr>
                                                    <?php } ?>
                                                </tbody>
                                            </table>
                                        ...
                                        <div class="d-flex flex-row-reverse">
                                            <button id="addCommande" type="button" class="btn btn-primary" style="background-color: #6d358b ; border-color:#6d358b ; color:white" data-toggle="modal" data-target="#addModal">
                                                ...
                                                <span class="text">Modifer La Commande</span>
                                            </button>
                                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#addDiv").on('click', '#addBtn', function() {
                ...
                if (item != '' && quantite != 0 && $('#showTable tr > td:contains(' + item + ')').length == 0 && arrData.some(data => data.name === item.trim()) == false) {
                    $("#checkProduct").html("");
            ...
            $("#addCommande").click(function() {
                ...
                if (arrData.length > 0) {
                    $.ajax({
                        type: "POST",
                        url: "http://localhost:8000/api/updateCommandes",
                        data: {
                            user_id: <?php echo $_SESSION["User_ID"] ?>,
                            pdv_id: '<?php echo $arrayCommande->Pdv->id ?>'
                        },
                        success: function(rsp) {
